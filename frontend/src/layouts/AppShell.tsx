...
const MOBILE_NAV_ITEMS: MobileNavItem[] = [
  ...
  { label: "Hybrid Decisions", to: "/hybrid-decisions", icon: Combine },
  ...
  { label: "Model Lifecycle", to: "/model-lifecycle", icon: FlaskConical, roles: ["admin", "owner", "platform_admin"] },
...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/anomaly-predictions": "AI Anomaly Predictions",
  "/hybrid-decisions": "Hybrid Decisions",
  "/replay": "Historical Replay",
  "/alerts": "Alerts",
  "/notifications": "Notifications",
  "/recovery-actions": "Recovery Actions",
  "/recovery-command": "Recovery Command",
  "/recovery-commands": "Recovery Command Centre",
  "/incidents": "Incidents",
  "/reports": "Reports",
