...
const ScrollAnimatedHero: React.FC<ScrollAnimatedHeroProps> = ({
  brandName = 'SentinelX',
  tagline = 'Distributed Monitoring & Self-Healing Platform',
  ctaText = 'Log in',
  onCtaClick,
}) => {
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes node-glow {
          0%, 100% { box-shadow: 0 0 10px rgba(79, 70, 229, 0.4), 0 0 20px rgba(79, 70, 229, 0.2); transform: scale(1); }
          50% { box-shadow: 0 0 20px rgba(79, 70, 229, 0.8), 0 0 40px rgba(79, 70, 229, 0.4); transform: scale(1.3); }
        }
        .sx-hero-tech-grid {
          position: absolute;
          inset: 0;
        ...
        .sx-hero-scan {
          ...
          width: 100%;
          height: 2px;
          background: linear-gradient(90deg, transparent, rgba(79, 70, 229, 0.55), transparent);
        ...
        .sx-hero-aurora-3 {
          ...
          background: radial-gradient(circle, rgba(129, 140, 248, 0.2) 0%, rgba(129, 140, 248, 0.05) 50%, transparent 100%);
          top: 50%; left: 50%;
        ...
        .hover\\:shadow-xl:hover {
          box-shadow: 0 20px 25px -5px rgba(79, 70, 229, 0.12), 0 10px 10px -5px rgba(79, 70, 229, 0.06);
        }
        @keyframes pulse-glow {
          0%, 100% { box-shadow: 0 20px 50px rgba(79, 70, 229, 0.4), 0 0 30px rgba(79, 70, 229, 0.3), 0 0 0 0 rgba(79, 70, 229, 0.7); }
          50% { box-shadow: 0 20px 60px rgba(79, 70, 229, 0.6), 0 0 50px rgba(79, 70, 229, 0.5), 0 0 0 10px rgba(79, 70, 229, 0); }
        }
        .sx-hero-cta {
      ...
      <div
        ref={heroRef}
        className="relative min-h-screen w-full overflow-hidden bg-[#eef1f7]"
      ...
      >
        ...
        >
          ...
          <p
            ref={taglineRef}
            className="sx-hero-tagline mb-16 max-w-2xl text-center text-xl font-medium tracking-wide sm:text-2xl md:text-3xl text-indigo-600"
          >
            {tagline}
          </p>
          ...
          <div ref={ctaRef} className="sx-hero-cta-wrap">
            <button
              ...
              style={{
                ...
                color: '#ffffff',
                boxShadow: '0 20px 50px rgba(79, 70, 229, 0.4), 0 0 30px rgba(79, 70, 229, 0.3)',
        ...
        >
          <div className="flex flex-col items-center gap-2">
            <span className="text-sm font-medium tracking-wider text-indigo-600">SCROLL</span>
            <div className="h-12 w-6 rounded-full border-2 border-indigo-500 p-1">
              <div
      ...
      <div className="relative z-20 min-h-screen w-full px-6 py-24 bg-[#eef1f7]">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-12 text-center text-4xl font-bold md:text-5xl text-indigo-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {/* Feature 1 */}
            <div className="flex flex-col items-center text-center p-8 rounded-2xl transition-all duration-300 hover:shadow-xl bg-indigo-50 backdrop-blur-sm">
              <div className="mb-6 w-20 h-20 rounded-full flex items-center justify-center bg-indigo-100">
                <svg className="w-10 h-10 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-3 text-indigo-600">Real-Time Monitoring</h3>
            ...
            <div className="flex flex-col items-center text-center p-8 rounded-2xl transition-all duration-300 hover:shadow-xl bg-indigo-50 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3 text-indigo-600">Smart Alerting</h3>
              <p className="text-base leading-relaxed text-slate-600">
            ...
            <div className="flex flex-col items-center text-center p-8 rounded-2xl transition-all duration-300 hover:shadow-xl bg-indigo-50 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3 text-indigo-600">Comprehensive Analytics</h3>
              <p className="text-base leading-relaxed text-slate-600">
        ...
        <defs>
          <pattern id="sx-hero-circuit" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
            <path
              ...
              strokeDasharray="5,5"
            />
            <circle cx="50" cy="100" r="3" fill="rgba(79, 70, 229, 0.6)" />
            <circle cx="100" cy="50" r="3" fill="rgba(79, 70, 229, 0.6)" />
            <circle cx="150" cy="100" r="3" fill="rgba(79, 70, 229, 0.6)" />
          </pattern>
        </defs>
