  ...
  return (
    <>
      <style>{`
        ...
        @keyframes node-glow {
          0%, 100% { box-shadow: 0 0 10px rgba(220, 38, 38, 0.4), 0 0 20px rgba(220, 38, 38, 0.2); transform: scale(1); }
          50% { box-shadow: 0 0 20px rgba(220, 38, 38, 0.8), 0 0 40px rgba(220, 38, 38, 0.4); transform: scale(1.3); }
        }
        .sx-hero-tech-grid {
          position: absolute;
          inset: 0;
        ...
        .sx-hero-data-stream {
          ...
          pointer-events: none;
          text-shadow: 0 0 8px rgba(220, 38, 38, 0.45);
          letter-spacing: 2px;
        ...
        .sx-hero-aurora-2 {
          ...
          background: radial-gradient(circle, rgba(220, 38, 38, 0.25) 0%, rgba(220, 38, 38, 0.08) 50%, transparent 100%);
        ...
        .hover\\:shadow-xl:hover {
          box-shadow: 0 20px 25px -5px rgba(220, 38, 38, 0.12), 0 10px 10px -5px rgba(220, 38, 38, 0.06);
        }
        @keyframes pulse-glow {
          0%, 100% { box-shadow: 0 20px 50px rgba(220, 38, 38, 0.4), 0 0 30px rgba(220, 38, 38, 0.3), 0 0 0 0 rgba(220, 38, 38, 0.7); }
          50% { box-shadow: 0 20px 60px rgba(220, 38, 38, 0.6), 0 0 50px rgba(220, 38, 38, 0.5), 0 0 0 10px rgba(220, 38, 38, 0); }
        }
        .sx-hero-cta {
        ...
        .sx-hero-splitwordmark .split-char:last-child {
          background: linear-gradient(180deg, #2dd4bf 0%, #dc2626 60%, #991b1b 100%);
          -webkit-background-clip: text;
          background-clip: text;
          -webkit-text-fill-color: transparent;
        }
      ...
      >
          ...
          <div ref={ctaRef} className="sx-hero-cta-wrap">
            <button
              ...
              style={{
                ...
                color: '#ffffff',
                boxShadow: '0 20px 50px rgba(220, 38, 38, 0.4), 0 0 30px rgba(220, 38, 38, 0.3)',
        ...
        >
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="h-12 w-6 rounded-full border-2 border-[#dc2626] p-1">
              <div
      ...
      <div className="relative z-20 min-h-screen w-full px-6 py-24 bg-[#f6f6f4]">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-12 text-center text-4xl font-bold md:text-5xl text-[#b91c1c]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="flex flex-col items-center text-center p-8 rounded-2xl transition-all duration-300 hover:shadow-xl bg-[#eef6f5] backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3 text-[#b91c1c]">Real-Time Monitoring</h3>
            ...
            <div className="flex flex-col items-center text-center p-8 rounded-2xl transition-all duration-300 hover:shadow-xl bg-[#eef6f5] backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3 text-[#b91c1c]">Smart Alerting</h3>
              <p className="text-base leading-relaxed text-slate-600">
            ...
            <div className="flex flex-col items-center text-center p-8 rounded-2xl transition-all duration-300 hover:shadow-xl bg-[#eef6f5] backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold mb-3 text-[#b91c1c]">Comprehensive Analytics</h3>
              <p className="text-base leading-relaxed text-slate-600">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20">
            <div className="text-center p-6">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-[#b91c1c]">99.9%</div>
              <div className="text-sm md:text-base sx-c-text0">Fleet Uptime</div>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-[#b91c1c]">Real-time</div>
              <div className="text-sm md:text-base sx-c-text0">Telemetry</div>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-[#b91c1c]">24/7</div>
              <div className="text-sm md:text-base sx-c-text0">Active Monitoring</div>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl md:text-5xl font-bold mb-2 text-[#b91c1c]">Multi-tenant</div>
        ...
        <defs>
          <pattern id="sx-hero-circuit" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
            <path
              ...
              strokeDasharray="5,5"
            />
            <circle cx="50" cy="100" r="3" fill="rgba(220, 38, 38, 0.6)" />
            <circle cx="100" cy="50" r="3" fill="rgba(220, 38, 38, 0.6)" />
            <circle cx="150" cy="100" r="3" fill="rgba(220, 38, 38, 0.6)" />
          </pattern>
        </defs>
