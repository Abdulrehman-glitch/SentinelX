...
def create_alert_rule(
    ...
    """
    Creates a configurable alert threshold rule.
    """
...
def list_alert_rules(
    ...
    """
    Returns alert rules with optional enabled filter.
    """
    ...
    if enabled is not None:
        statement = (
            select(AlertRule)
            .where(AlertRule.enabled.is_(enabled))
...
def get_alert_rule(
    ...
    return _get_rule_or_404(rule_id=rule_id, db=db)
...
def update_alert_rule(
    ...
    rule = _get_rule_or_404(rule_id=rule_id, db=db)
...
def toggle_alert_rule(
    ...
    """
    Toggles an alert rule between enabled and disabled.
    """
